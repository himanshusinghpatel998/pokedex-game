...
const LoginForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // First, login
      const response = await fetch("https://considerate-alignment-production-2d97.up.railway.app/api/login", {
        method: "POST",
      ...
      if (data.success) {
        ...
        const validateResponse = await fetch(
          "https://considerate-alignment-production-2d97.up.railway.app/api/validate",
          {
            method: "GET",
            headers: {
